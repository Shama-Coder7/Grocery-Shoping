...
function offCanvasNav(opts) {
   ...
   /* content.click( function() {
    ...
    $('.nav_close_btn,.popup_outer').click( function() {
       $('.left_menu_1').removeClass('openMenu');
	   $('.popup_outer').hide();
    });
    ...
    $(document).ready(function() {
        ...
        $('nav.off_canvas > ul li ul').first().addClass('nav_level_current');

        //$('.has_levels > a').append('<span class="nav_next_btn">'+nav_next_btn+'</span>');
        $('.has_levels > a').addClass('nav_next_btn');
        ...
        $('.nav_prev_btn').click( function(e) {
            ...
            if( $('nav.off_canvas > ul li ul').first().hasClass('nav_level_current') ) {
                $('.nav_prev_btn').fadeOut(400);
            }
